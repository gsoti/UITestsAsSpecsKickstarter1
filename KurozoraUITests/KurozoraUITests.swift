...
final class KurozoraUITests: XCTestCase {
...
//        app.launch()
        ...
        app.launchTunnel(withOptions: [SBTUITunneledApplicationLaunchOptionResetFilesystem, SBTUITunneledApplicationLaunchOptionDisableUITextFieldAutocomplete]) {
            ...
            let match = SBTRequestMatch(url: "v1/info")
            let stubId = self.app.stubRequests(matching: match, response: .info(isMaintenanceModeEnabled: true))
        }
